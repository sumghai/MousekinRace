...
namespace MousekinRace
{
    public static class AllegianceSys_Utils
    {
        ...
        public static void JoinFaction(Faction allegianceFaction)
        {
            ...
            List<Pawn> colonists = PawnsFinder.AllMapsCaravansAndTravellingTransporters_Alive_FreeColonists.Where(p => !p.IsSlave && !p.IsPrisoner).ToList();
        ...
        public static List<Tuple<Pawn, string>> GetQuittingColonistsWithReasons(Faction allegianceFaction)
        {
            ...
            List<Pawn> tempAllColonists = PawnsFinder.AllMapsCaravansAndTravellingTransporters_Alive_FreeColonists.Where(p => !p.IsSlave && !p.IsPrisoner).ToList();
