...
{
    // Skip listing items stored inside Root Cellars in the Cell Inspector context popup
    // (Mouse over cell while holding Alt key)
    ...
    public static class Harmony_CellInspectorDrawer_DrawThingRow_RootCellarsSkipListingContents
    {
        ...
        {
            return !Building_CellarOutdoor.ThingIsInCellar(thing);
        }
    }
}
